package sarlota.services.repositories;
...
public interface ZaposleniRepository extends JpaRepository<Zaposleni, Integer> {
    ...
    @Query(value = "SELECT z FROM Zaposleni z WHERE (z.ime LIKE ?1 OR z.prezime LIKE ?1 OR z.korisnickoIme LIKE ?1 OR z.tipZaposlenog LIKE ?1)")
